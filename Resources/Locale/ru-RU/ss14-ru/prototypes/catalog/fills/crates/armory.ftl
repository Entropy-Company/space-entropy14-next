...
ent-CrateArmoryRifle = ящик винтовок
    .desc = Содержит две мощные штурмовые винтовки с четырьмя магазинами. Для открытия требуется доступ в Арсенал.
ent-CratePlants = ящик растений
    .desc = Набор разнообразных комнатных растений, чтобы украсить вашу станцию!
ent-CrateAirGrenade = ящий воздушных гранат
    .desc = Ящик, содержащий 3 воздушные гранаты.
ent-CrateServiceCleanerGrenades = ящик с чистящими гранатами
    .desc = Содержит две коробки чистящих гранат для самых застарелых пятен.