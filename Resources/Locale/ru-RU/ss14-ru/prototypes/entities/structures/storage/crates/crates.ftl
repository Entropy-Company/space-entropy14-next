...
ent-CrateRodentCage = хомячья клетка
    .desc = { ent-CrateGeneric.desc }
ent-CrateBaseLockBox = защищенный ящик
    .desc = Надёжный защищенный ящик. Средства от его продажи будут распределены обратно по отделам. Только не забывайте: Каргония всегда берёт свою долю.
ent-CrateLockBoxEngineering = инженерный защищенный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = медицинский защищенный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = научный защищенный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = охранный защищенный ящик
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = сервисный защищенный ящик
    .desc = { ent-CrateBaseLockBox.desc }
