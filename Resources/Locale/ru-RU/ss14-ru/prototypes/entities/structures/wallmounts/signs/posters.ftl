...
ent-PosterContrabandRealExomorph = Настоящий! Эксоморф!
    .desc = Заговорщический плакат о опасных инопланетных формах жизни.
ent-PosterContrabandLustyExomorph = Похотливая эксо дева
...
ent-PosterContrabandRouny = Видели его?
    .desc = Старый постер с объявлением о пропавшем пришельце. Куда же он сбежал?
...
ent-PosterContrabandBustyBackdoorExoBabes6 = Фигуристые Эксо-Малышки 6
    .desc = Зарядись (или разрядись) с этими полностью натуральными эксо-малышками!
...
ent-PosterContrabandExoAcid = Предупреждение: Экcоморф — Кислотная слюна!
    .desc = Этот плакат предупреждает вас о кислотной слюне экзоморфа. Хотя такие экcоморфы вроде бы не существуют... Правда?
ent-PosterContrabandExoRun = Предупреждение: Экcоморф — Бегите!
    .desc = Этот плакат предупреждает вас об атлетичном экcоморфе, способном утащить любого, кто попадётся; так что не попадитесь!
ent-PosterContrabandExoChomp = Предупреждение: Экcоморф — Опасные укусы!
    .desc = Этот плакат предупреждает о смертельно опасных укусах экcоморфов. Не станьте инопланетным перекусом!
