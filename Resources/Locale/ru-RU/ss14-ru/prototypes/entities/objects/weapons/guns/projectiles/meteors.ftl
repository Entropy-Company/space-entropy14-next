...
ent-MeteorUrist = Урист МакМетеор
    ...
    .suffix = Метеор
ent-MeteorCow = Космо-корова
    .desc = Му-вимся с релятивистской скоростью!
    .suffix = Метеор
ent-MeteorClown = Хонкостероид
    .desc = Последний хонкинг
    .suffix = Метеор
ent-MeteorPotato = Космо картошка
    .desc = Крахмальная угроза из глубин космоса. Содержит 200% суточной нормы натрия! А еще их любят белорусы.
