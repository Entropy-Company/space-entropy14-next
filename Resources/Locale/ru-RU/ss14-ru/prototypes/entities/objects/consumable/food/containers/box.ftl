...
ent-FoodBoxDonkpocketMoth = коробка мольных донкпокетов
    .desc = { ent-FoodBoxDonkpocket.desc }
...
ent-FoodMealHappyHonkBigBite = Большой перекус Happy Honk
    .desc = Кто-то заплатил хорошие деньги, чтобы доставить этот фастфуд сюда. Он каким-то образом пахнет свежестью.
