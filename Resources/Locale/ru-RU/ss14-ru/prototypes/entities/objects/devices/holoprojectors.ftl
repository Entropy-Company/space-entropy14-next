...
ent-HolofanProjectorBorg = встроенный голопроектор
    .desc = Не дает идиотам причинять больше вреда экипажу во время атмосферных аварий. Устанавливается непосредственно в инженерного киборга, перезаряжается со временем.
